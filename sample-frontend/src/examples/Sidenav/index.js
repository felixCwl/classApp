...
function Sidenav({ color, brand, brandName, routes, ...rest }) {
  ...
  return (
    ...
    >
      <SampleBox pt={3} pb={1} px={4} textAlign="center">
        <SampleBox
          ...
          sx={{ cursor: "pointer" }}
        >
          <SampleTypography variant="h6" color="secondary">
        ...
        <SampleBox component={NavLink} to="/" display="flex" alignItems="center">
          ...
          >
            <SampleTypography component="h6" variant="button" fontWeight="medium" color={textColor}>
              {brandName}
            </SampleTypography>
          </SampleBox>
        </SampleBox>
