...
function Transactions() {
  return (
    <Card sx={{ height: "100%" }}>
      <SampleBox display="flex" justifyContent="space-between" alignItems="center" pt={3} px={2}>
        <SampleTypography variant="h6" fontWeight="medium" textTransform="capitalize">
          Your Transaction&apos;s
        </SampleTypography>
        <SampleBox display="flex" alignItems="flex-start">
          <SampleBox color="text" mr={0.5} lineHeight={0}>
